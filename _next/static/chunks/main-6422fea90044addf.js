            ...
            return (
              ...
              (l.cn = function () {
                ...
                performance.now() > l.un + 6e4
                  ? ((l.vn = t), e.removeEventListener("updatefound", l.cn))
                  : ((l.hn = t), l.an.add(t), l.rn.resolve(t)),
                  ++l.tn,
                ...
                !a && l.mn && (i.isUpdate = !0),
                  ...
                  "installed" === n
                    ? (l.wn = self.setTimeout(function () {
                        "installed" === n &&
                          t.waiting === r &&
                          l.dispatchEvent(new o("waiting", i));
                      }, 200))
                    : "activating" === n &&
                      (clearTimeout(l.wn), a || l.en.resolve(r));
              }),
              (l.dn = function (e) {
                var t = l.hn,
                      ...
                      i(u.bn(), function (e) {
                        (u.fn = e),
                          u.yn &&
                            ...
                            u.en.resolve(u.yn),
                            u.on.resolve(u.yn),
                            u.yn.addEventListener("statechange", u.ln, {
                              once: !0,
                            }));
                        var t = u.fn.waiting;
                        return (
          ...
          async change(e, t, r, n, a) {
            ...
            try {
              ...
              if (
                ...
                let e = (0, j.hasBasePath)(et.pathname)
              ...
              if ((o.__N_SSG || o.__N_SSP) && o.props) {
                ...
                if (
                  ((z.isPreview = !!o.props.__N_PREVIEW), o.props.notFound === W)
                ) {
                  let e;
                  try {
              ...
              let P =
                F && !y && !V && !ee && (0, R.compareRouterStates)(v, this.state);
              if (!P) {
                try {
                  await this.set(v, o, y);
                } catch (e) {
                ...
                if (o.error)
                  throw (
                    (F || X.events.emit("routeChangeError", o.error, Z, Q),
                    o.error)
                  );
                F || X.events.emit("routeChangeComplete", r, Q),
