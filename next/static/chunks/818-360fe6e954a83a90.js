    ...
    [818],
    {
        ...
        let s = ["?demo=true"],
          o = (0, e.forwardRef)((a, i) => {
            let {
              ...
              l = { ref: i, className: o, ...c },
              p = (0, e.useMemo)(
                () =>
                  (null == t ? void 0 : t.startsWith("mailto:")) ||
                  (null == t ? void 0 : t.startsWith("tel:")),
                [t]
              ),
              h = (0, e.useMemo)(
                () => !!s.find((a) => (null == t ? void 0 : t.includes(a))),
                [t]
              ),
              d = (0, e.useMemo)(
              ...
              f = (0, e.useMemo)(
                () => (null == t ? void 0 : t.startsWith("http")),
                [t]
              );
            return "string" != typeof t
              ? (0, r.jsx)("button", { ...l, children: k })
              : p || f
              ? (0, r.jsx)("a", {
                  ...l,
                  href: t,
        ...
        function e(a) {
          ...
          return (
            ...
            (0, x.useEffect)(() => {
              ...
              if (l)
                return (
                  "string" == typeof i && i.includes("http")
                    ? y(i).then((a) => {
                        c.current =
                          null == l
                            ? void 0
                  ...
                  null === (a = c.current) || void 0 === a || a.setSpeed(e),
                  () => {
                    var a;
                    return null === (a = c.current) || void 0 === a
                      ? void 0
                      : a.destroy();
                  }
                );
            ...
            (0, x.useEffect)(() => {
              ...
              c.current && d.isIntersecting
                ? null === (a = c.current) || void 0 === a || a.play()
                : null === (i = c.current) || void 0 === i || i.pause();
            }, [c.current, d.isIntersecting]),
            (0, r.jsx)("div", {
              "aria-hidden": "true",
              className: o,
      ...
      818: function (a, i, t) {
            ...
            children: [
              (0, r.jsxs)(n(), {
                children: [
                  ...
                  (0, r.jsx)("meta", { name: "theme-color", content: "#241ff3" }),
                ],
              }),
              (0, r.jsx)(s.PB, {
                  ...
                  images: [
                    {
                      url: k
                        ? k.url
                        : "https://drive-capital-website.vercel.app/api/og?pagename=drive%20capital",
        ...
        var c = JSON.parse(
          ...
          E = t(4832),
          D = t.n(E);
        let S = y()(() => t.e(535).then(t.bind(t, 535)), {
            loadableGenerated: { webpack: () => [535] },
            ssr: !1,
          }),
          B = y()(() => t.e(6202).then(t.bind(t, 6202)), {
            loadableGenerated: { webpack: () => [6202] },
          }),
          A = y()(() => t.e(8393).then(t.bind(t, 8393)), {
            loadableGenerated: { webpack: () => [8393] },
          }),
          V = y()(() => t.e(8199).then(t.bind(t, 8199)), {
            loadableGenerated: { webpack: () => [8199] },
          }),
          b = y()(() => t.e(7213).then(t.bind(t, 7213)), {
            loadableGenerated: { webpack: () => [7213] },
          }),
          v = (a) => {
            let { className: i } = a,
              t = (0, d.o)((a) => a.footerData),
              { register: k, handleSubmit: x, reset: s } = (0, u.cI)(),
              [o, n] = (0, G.f)({
                url: "https://drivecapital.us16.list-manage.com/subscribe/post?u=925d0b35f123daab6bd3b6fcf&amp;id=79781d1105",
              }),
              { data: m } = o;
            return (0, r.jsxs)("footer", {
              className: (0, e.Z)(D().footer, i),
              children: [
                (0, r.jsxs)("div", {
                  className: (0, e.Z)("layout-block-inner", D().inner),
                  children: [
                    t.headline &&
                      (0, r.jsx)("h3", {
                        className: (0, e.Z)(D().title, "h6"),
                        children: t.headline,
                      }),
                    t.lottieAsset.url &&
                      (0, r.jsx)("div", {
                        className: D()["lottie-map"],
                        children: (0, r.jsx)(p.Lottie, {
                          className: D().lottie,
                          animation: c,
                          speed: 0.7,
                          loop: !1,
                    ...
                    (0, r.jsxs)("div", {
                      className: (0, e.Z)(D()["inner-bottom"], "layout-grid"),
                      children: [
                        (0, r.jsxs)("form", {
                          className: D().form,
                          onSubmit: x((a) => {
                        ...
                        t.leftLinksColumnCollection.items.length > 0 &&
                          (0, r.jsx)("ul", {
                            className: (0, e.Z)(D()["left-nav"], "p-s"),
                            children: t.leftLinksColumnCollection.items.map(
                              (a, i) => {
                                let { text: t, url: k } = a;
                                return (0, r.jsx)(
                                  "li",
                        ...
                        t.rightLinksColumnCollection.items.length > 0 &&
                          (0, r.jsx)("ul", {
                            className: (0, e.Z)(D()["right-nav"], "p-s"),
                            children: t.rightLinksColumnCollection.items.map(
                              (a, i) => {
                                let { text: t, url: k } = a;
                                return (0, r.jsx)(
                                  "li",
                        ...
                        (0, r.jsx)(S, { className: D()["iso-logo"] }),
                      ],
                    }),
                  ],
                }),
                (0, r.jsxs)("div", {
                  className: (0, e.Z)(D().bottom, "layout-grid"),
                  children: [
                        ...
                        children: t.socialLinksCollection.items.map((a, i) => {
                          ...
                          return (0, r.jsxs)(
                            h.Z,
                            {
                              ...
                              href: t,
                              children: [
                                t.includes("twitter") && (0, r.jsx)(B, {}),
                                t.includes("@") && (0, r.jsx)(A, {}),
                                t.includes("linkedin") && (0, r.jsx)(V, {}),
                                t.includes("youtube") && (0, r.jsx)(b, {}),
                              ],
                            },
                    ...
                    (0, r.jsx)("p", {
                      className: (0, e.Z)(D().address, "p-s"),
                      children: "629 N. HiGH STREET COLUMBUS, OH 43215",
                    }),
                    (0, r.jsxs)("p", {
                      className: (0, e.Z)(D().date, "p-s"),
          ...
          g = (a) => {
            ...
            if (!i || !t) return null;
            let k = t.includes("is already subscribed to list")
              ? t.split(" <a href=")[0]
              : t;
            return (0, r.jsx)("p", {
              style: { color: "success" === i ? "inherit" : "#ff0000" },
              className: (0, e.Z)(D()["mailchimp-message"], "p-s"),
              children: k,
            });
          };
        var j = t(8067),
          ...
          P = t(2943),
          _ = t.n(P);
        let N = y()(() => t.e(6202).then(t.bind(t, 6202)), {
            loadableGenerated: { webpack: () => [6202] },
          }),
          F = y()(() => t.e(8393).then(t.bind(t, 8393)), {
            loadableGenerated: { webpack: () => [8393] },
          }),
          L = y()(() => t.e(8199).then(t.bind(t, 8199)), {
            loadableGenerated: { webpack: () => [8199] },
          }),
          Z = y()(() => t.e(7213).then(t.bind(t, 7213)), {
            loadableGenerated: { webpack: () => [7213] },
          }),
          C = (a) => {
            let { data: i, className: t } = a,
              [k, x] = (0, d.o)((a) => [a.navIsOpen, a.setNavIsOpen], T.X),
              s = (0, d.o)((a) => {
                let { lenis: i } = a;
                return i;
              }),
            ...
            return (
              ...
              (0, r.jsxs)("div", {
                className: (0, e.Z)(_().menu, !k && _().closed, t),
                children: [
                  (0, r.jsx)("div", {
                  ...
                  (0, r.jsx)("div", {
                    ...
                    children: i.socialMedia.items.map((a, i) => {
                      ...
                      return (0, r.jsxs)(
                        l.r,
                        {
                          className: (0, e.Z)(_().icon, "h5"),
                          href: t,
                          children: [
                            t.includes("twitter") && (0, r.jsx)(N, {}),
                            t.includes("@") && (0, r.jsx)(F, {}),
                            t.includes("linkedin") && (0, r.jsx)(L, {}),
                            t.includes("youtube") && (0, r.jsx)(Z, {}),
                          ],
                        },
        ...
        var I = t(3017),
          M = t.n(I);
        let O = y()(() => t.e(4706).then(t.bind(t, 4706)), {
            loadableGenerated: { webpack: () => [4706] },
          }),
          R = y()(() => t.e(535).then(t.bind(t, 535)), {
            loadableGenerated: { webpack: () => [535] },
          }),
          q = (0, w.forwardRef)((a, i) => {
            let { isoLogo: t, appear: k, className: x } = a,
              [s, o] = (0, d.o)((a) => [a.navIsOpen, a.setNavIsOpen], T.X),
              n = (0, d.o)((a) => a.headerData);
            return (0, r.jsxs)("header", {
              ...
              children: [
                (0, r.jsx)(C, {
                  className: (0, e.Z)(x, "hide-on-desktop"),
                  data: n,
                }),
                (0, r.jsxs)("div", {
                  className: (0, e.Z)("layout-block", M().head),
                  children: [
                    (0, r.jsx)(l.r, {
                      href: "/",
                      children: t
                        ? (0, r.jsx)(R, { className: M()["iso-logo"] })
                        : (0, r.jsx)(O, { className: M().logo }),
                    }),
                    (0, r.jsxs)("div", {
                      className: M().menu,
                      children: [
                        (0, r.jsx)("nav", {
                          className: (0, e.Z)(M().nav, s && M().open, "p-s"),
                          "aria-hidden": !s,
                          onClick: () => {
                            o(!s);
                          },
                        ...
                        (0, r.jsxs)("button", {
                          ...
                          className: (0, e.Z)(M()["menu-button"], s && M().open),
                          children: [
                            (0, r.jsx)("div", {}),
                            (0, r.jsx)("div", {}),
                            (0, r.jsx)("div", {}),
        ...
        function $(a) {
          let {
            ...
            [p, h] = (0, d.o)((a) => [a.lenis, a.setLenis]),
            f = (0, d.o)((a) => a.setHeaderHeight),
            y = (0, j.useRouter)(),
            [u, { height: G }] = (0, U.Z)({ debounce: 100 }),
            [E, D] = (0, w.useState)(
              y.asPath.includes("#") ? "#" + y.asPath.split("#").pop() : void 0
            );
          (0, w.useEffect)(() => {
            let a = new x.Z({
                duration: 1.2,
          ...
          let [S] = (0, w.useState)(y.pathname),
            [B, A] = (0, w.useState)(!1);
          return (
            (0, w.useEffect)(() => {
              y.events.on("routeChangeStart", function (a) {
                a !== S && A(!0);
              });
            }, [y, S]),
            (0, w.useEffect)(() => {
            ...
            (0, r.jsxs)(r.Fragment, {
              children: [
                (0, r.jsx)(m, { ...i }),
                (0, r.jsxs)("div", {
                  className: (0, e.Z)("theme-".concat(s), J().layout, o),
                  children: [
                    (0, r.jsx)(z, {}),
                    (0, r.jsx)(q, {
                      isoLogo: l,
                    ...
                    (0, r.jsx)("main", { className: J().main, children: t }),
      ...
      4832: function (a) {
        a.exports = {
          ...
          title: "footer_title__q0weN",
          "lottie-map": "footer_lottie-map__rWT2p",
          "inner-bottom": "footer_inner-bottom__hHTY3",
          form: "footer_form__osjqq",
          input: "footer_input__xQZnf",
          submit: "footer_submit__LmOjz",
          "left-nav": "footer_left-nav__WkhCG",
          "right-nav": "footer_right-nav__N9Xcg",
          "iso-logo": "footer_iso-logo__uUqNv",
          bottom: "footer_bottom__VigXf",
          social: "footer_social__L0_TJ",
          address: "footer_address__p_BIK",
          date: "footer_date__Nnwwa",
          image: "footer_image__qtFUY",
          lottie: "footer_lottie__sQ2IR",
          "mailchimp-message": "footer_mailchimp-message__BXwui",
        };
      },
      3017: function (a) {
        a.exports = {
          header: "header_header__GSKJx",
          hide: "header_hide__fXrYP",
          fade: "header_fade__pfdov",
          appear: "header_appear__7IRop",
          head: "header_head__dyG_u",
          "iso-logo": "header_iso-logo__DeFd4",
          logo: "header_logo__d4jIK",
          menu: "header_menu__cDNP_",
          nav: "header_nav__zbhEe",
          open: "header_open___cToH",
          item: "header_item__MQUZG",
          text: "header_text__HDTE9",
          "menu-button": "header_menu-button__K0KjS",
        };
      },
      2943: function (a) {
        a.exports = {
          menu: "navigation_menu__a0LSK",
          closed: "navigation_closed__WYEwL",
          link: "navigation_link__MPiS5",
          social: "navigation_social__KlB8c",
          navigation: "navigation_navigation__8EURn",
          icon: "navigation_icon__XufVW",
        };
      },
      6677: function (a) {
        a.exports = {
      ...
      7959: function (a) {
        a.exports = { button: "social-button_button__mCINb" };
      },
      5303: function (a) {
        a.exports = {
